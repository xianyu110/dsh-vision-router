...
export function isProviderActive(ctx, provider) {
  ...
  try {
    // Match core.adapterAvailable(): DSH's registration() is fail-loud for an
    // unknown route, so successful completion itself is the structural fact.
    // Do not require a particular return shape across rc.6/rc.7.
