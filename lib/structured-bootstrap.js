...
export function normalizeStructuredBootstrapResult(parsed, raw = '') {
  ...
  return { visual_kind: visualKind, content_kind: contentKind, overview, regions, visible_text: visibleText, entities, relationships, uncertainties, recommended_followups: recommendedFollowups }
}
